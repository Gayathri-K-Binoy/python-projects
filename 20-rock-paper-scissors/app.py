...
def play_game():
    ...
    # no_winners variable is only set once before entering loop,but it's never updated inside loop. This means that
    # even when one player reaches target score, the condition won't change and the loop will run indefinitely (an infinite loop)   

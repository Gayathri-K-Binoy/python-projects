...
while True:
    ...
    print(f"response time {response_time}") #example output: 2.464748494048493
    ...
    rounds+=1
    print(f"Score: {score}/{5*rounds} possible points\n")

    #Ask to play again
    if input("Play again? (yes/no): ").lower().startswith("n"):
